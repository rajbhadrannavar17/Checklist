...
- `index.html` — interactive checklist web app
- `Checklist.pdf` — PDF version of the checklist

## References

The checklist links to relevant OWASP WSTG, OWASP API Security, PTES, MITRE, and NIST guidance where applicable.
